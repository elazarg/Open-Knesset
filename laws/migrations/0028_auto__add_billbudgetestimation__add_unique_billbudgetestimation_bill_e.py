...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'laws_billbudgetestimation', (
        ...
        db.send_create_signal(u'laws', ['BillBudgetEstimation'])

        # Adding unique constraint on 'BillBudgetEstimation', fields ['bill', 'estimator']
        db.create_unique(u'laws_billbudgetestimation', ['bill_id', 'estimator_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BillBudgetEstimation', fields ['bill', 'estimator']
        db.delete_unique(u'laws_billbudgetestimation', ['bill_id', 'estimator_id'])

        # Deleting model 'BillBudgetEstimation'
        db.delete_table(u'laws_billbudgetestimation')
