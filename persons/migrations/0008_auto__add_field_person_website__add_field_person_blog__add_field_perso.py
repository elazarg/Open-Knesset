...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'persons_person', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.blog'
        db.add_column(u'persons_person', 'blog',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planet.Blog'], unique=True, null=True, blank=True),
                      keep_default=False)
        ...
        db.alter_column(u'persons_person', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Person.website'
        db.delete_column(u'persons_person', 'website')

        # Deleting field 'Person.blog'
        db.delete_column(u'persons_person', 'blog_id')
